	...
	public void execute(Frame f) {
		...
		if(this.type.equals("Integer")) {
			if(a1.getType().equals(this.type)&&a2.getType().equals(this.type)) {
				...
				Variable product = new Variable(i1*i2);
				f.getOperandStack().push(product);
			}else {
			...
			if(a1.getType().equals(this.type)&&a2.getType().equals(this.type)) {
				...
				Variable product = new Variable(l1*l2);
				f.getOperandStack().push(product);
			}else {
				f.getOperandStack().push(a1);
				f.getOperandStack().push(a2);
			...
			if(a1.getType().equals(this.type)&&a2.getType().equals(this.type)) {
				...
				Variable product = new Variable(f1*f2);
				f.getOperandStack().push(product);
			}else {
				f.getOperandStack().push(a1);
				f.getOperandStack().push(a2);
			...
			if(a1.getType().equals(this.type)&&a2.getType().equals(this.type)) {
				...
				Variable product = new Variable(d1*d2);
				f.getOperandStack().push(product);
			}else {
				f.getOperandStack().push(a1);
				f.getOperandStack().push(a2);
